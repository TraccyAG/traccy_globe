...
Site.CanvasManager = function () {
  ...
  this.draw = function (timestamp) {
    ...
    // To slow globe speed go to lower value possible
    slowTime = timestamp * 0.0001;
    ...
    if (Site.isMobile) {
      let scale = ((1 - window.innerWidth / 1024) * Site.scale + window.innerWidth / 1024) * 12 + 5;
  ...
  this.pulse = function (width, height, variety, duration, waveVector) {
    ...
    a.updateFn = function (value) {
      ...
      self.globe.ringEffectStr = BK.Ease.smoothstep(0.0, 0.5, value) - BK.Ease.smoothstep(0.8, 1.0, value);
    }
    a.start();
  }
